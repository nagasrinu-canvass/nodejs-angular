...
(function (app) {
    ...
    app.controller("listController", function ($scope, $element, UserService, PaginationFactory) {
        $scope.searchBy = "";
        $scope.listTitle = "Users List";
        $scope.list;
        $scope.pageSize = 10;
        $scope.pageNumber = 1;
        $scope.totalPages = 0;
    ...
    app.controller("userRootController", function ($scope) {
        $scope.currentView = "list";
        $scope.roles = [
            {id: 'CRT', label: 'CRT'},
            {id: 'BUR', label: 'BU Reviewer'},
            {id: 'BUL', label: 'BU Lead'},
