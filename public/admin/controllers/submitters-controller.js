 ...
 */
(function (app) {
    app.controller("submittersListController", function ($scope, $element, UserService, PaginationFactory) {
        $scope.searchBy = "";
        $scope.listTitle = "Submitters List";
        $scope.list;
        $scope.pageSize = 10;
        $scope.pageNumber = 1;
        $scope.totalPages = 0;
        ...
        function _search() {
            //$scope.loading = true;
            UserService.search($scope.searchBy,
    ...
    app.controller("submittersUserController", function ($scope) {
        $scope.user = {};
    ...
    app.controller("submiterRootController", function ($scope) {
